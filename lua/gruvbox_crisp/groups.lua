...
function M.get(p, o)
  ...
  local groups = {
    ...
    NormalFloat  = { fg = p.fg0, bg = transparent and p.none or p.bg1 },
    FloatBorder  = { fg = p.border_focus, bg = transparent and p.none or p.bg1 },
    ...
    LineNr       = { fg = p.gray },
    WinSeparator = { fg = p.border_focus, bg = transparent and p.none or p.bg0 },
    VertSplit    = { link = "WinSeparator" },
    StatusLine   = { fg = p.bg0, bg = p.border_focus, bold = true },
    StatusLineNC = { fg = p.fg1, bg = p.bg2 },
    TabLine      = { fg = p.fg1, bg = p.bg1 },
    TabLineSel   = { fg = p.bg0, bg = p.border_focus, bold = true },
